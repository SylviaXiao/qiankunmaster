...
import { cashJourneyFirstColumns, pageSizeOptions } from '@/utils/tableDetails/details'
import { STable } from '@/components'
import { operatingExpenseFlowListDetails } from '@/api/table/table'
export default {
  ...
  data() {
    return {
      ...
      columns: cashJourneyFirstColumns,
      queryParam: {},
      loadData: parameter => {
        ...
        let request = operatingExpenseFlowListDetails
  ...
  watch: {
    $route: {
      handler: function(route) {
        if (route.name == 'cashJournalDetail') {
  ...
  methods: {
    //导出
    downloadStu() {
      let exportUrl = '/finance/spending/operatingExpenseFlowListDetailsByExportExcel'
