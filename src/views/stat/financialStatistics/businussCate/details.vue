  ...
  watch: {
    $route: {
      handler: function(route) {
        if (route.name == 'businussCateDetail') {
          let ids = localStorage.getItem('businussCateDetailId')
          ...
          //设置打印链接
          if (this.feeType == 'A') this.exportUrl = '/finspending/capitalDaily/operatingExpenseFlowStatisticsSplitByExportExcel'
          if (this.feeType == 'B') this.exportUrl = '/finspending/capitalDaily/operatingExpenseFlowStatisticsSplitByCostClassifyAndExportExcel'
          if (this.feeType == 'C') this.exportUrl = '/finspending/capitalDaily/operatingExpenseFlowStatisticsSplitDetailsByExportExcel'
