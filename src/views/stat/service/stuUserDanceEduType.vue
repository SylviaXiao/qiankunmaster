<template>
  <div class="fin-achievement-wrapper">
    <f-frame :searchParamsArray="searchParams" src="/report?name=stuUser_dance_eduType" perm="service:stat:stuuer:danceEdutype" date="month"></f-frame>
  </div>
</template>

<script>
import moment from 'moment'
import { listEduType, listChannelTree } from '@/api/common'
