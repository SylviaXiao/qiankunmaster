...
<script>
  ...
  import { noFinancePrivateEduAuditionCourseEnrollMasterReport } from '@/api/organize'
  ...
  export default {
    ...
    methods: {
      ...
      initTable() {
        this.spinning = true
        noFinancePrivateEduAuditionCourseEnrollMasterReport(Object.assign({}, this.queryParam))
          .then(res => {
      ...
      downloadStu() {
        let exportUrl = '/auditionCourseNoFinanceEnroll/privateEduAuditionCourseEnrollMasterReportByExport'
