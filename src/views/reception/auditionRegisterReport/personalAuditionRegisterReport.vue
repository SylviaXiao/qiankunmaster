...
<script>
  ...
  import { personalAuditionRegisterReport } from '@/api/organize'
  ...
  export default {
    ...
    methods: {
      ...
      initTable() {
        this.spinning = true
        personalAuditionRegisterReport(Object.assign({}, this.queryParam))
          .then(res => {
      ...
      downloadStu() {
        let exportUrl = '/auditionCourseEnroll/privateEduAuditionCourseEnrollMasterReportByExport'
