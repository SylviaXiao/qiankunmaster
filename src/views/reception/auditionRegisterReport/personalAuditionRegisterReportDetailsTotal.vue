...
<script>
  ...
  import { totalPersonalAuditionRegisterReportDetails1, totalPersonalAuditionRegisterReportDetails2 } from '@/api/organize'
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        loadData: parameter => {
          ...
          if (detailType === 'audition') {//体验人数
            return totalPersonalAuditionRegisterReportDetails1(params).then(res => {
              return res
            })
          } else if (detailType === 'enroll') {//报名人数||报名金额
            params.page = 0
            params.limit = 0
            return totalPersonalAuditionRegisterReportDetails2(params).then(res => {
              return res
            })
          }
        },
    ...
    methods: {
      ...
      downloadStu() {
        let exportUrl1 = '/auditionCourseTotalEnroll/privateEduAuditionCourseEnrollMasterDetails1ByExportExcel'
        let exportUrl2 = '/auditionCourseTotalEnroll/privateEduAuditionCourseEnrollMasterDetails2ByExportExcel'
